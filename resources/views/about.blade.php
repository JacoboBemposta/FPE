            ...
            <div class="card border-0 shadow-lg p-5 mb-5" style="border-radius: 20px;">
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        ...
                        <p class="fs-5 text-dark mb-4">
                            Como profesionales con <strong>poca experiencia pero mucho entusiasmo</strong>, comprendimos que el proceso tradicional de búsqueda de empleo docente era fragmentado, lento y poco eficiente. Las academias tenían dificultades para encontrar docentes cualificados, mientras que los profesores luchaban por visibilizar su potencial.
                        </p>
                        <p class="fs-5 text-dark mb-0">
                            Esta dualidad de necesidades nos inspiró a crear una <strong>soluón integral</strong> que transformara la forma en que el sector educativo se conecta, contrata y colabora.
                        </p>
                    </div>
