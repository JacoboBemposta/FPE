            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="ident" class="col-md-4 col-form-label text-md-end">{{ __('Identificación') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <label for="numero_censo" class="col-md-4 col-form-label text-md-end">{{ __('Número de Censo') }}</label>
                            <div class="col-md-6">
                                <input id="numero_censo" type="text" class="form-control @error('numero_censo') is-invalid @enderror" 
                                    name="numero_censo" value="{{ old('numero_censo') }}" required>
                                @error('numero_censo')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
