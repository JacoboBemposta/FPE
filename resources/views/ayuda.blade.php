...
<div class="col-md-6 col-lg-3">
    <div class="card border-0 h-100 shadow-sm hover-card text-center">
        <div class="card-body p-4">
            ...
            <!-- Botón para abrir modal con el video -->
            <button type="button" 
                    class="btn btn-outline-primary btn-sm fw-semibold"
                    data-bs-toggle="modal" 
                    data-bs-target="#videoTutorialModal">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tutorial para Academias</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-0">
                <div class="ratio ratio-16x9">
                    <iframe src="https://www.youtube.com/embed/34tXk7AQLCQ" 
                            title="Video tutorial para academias - RedFPE" 
                            frameborder="0" 
            ...
            <div class="modal-footer justify-content-center">
                <a href="https://www.youtube.com/watch?v=34tXk7AQLCQ" 
                   target="_blank" 
