...
<head>
    ...
    <title>{{ config('app.name', 'RedFPE') }} - Plataforma Educativa</title>
    <link rel="icon" type="image/x-icon" href="{{ asset('mundo.png') }}">
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('mundo.png') }}" alt="RedFPE Logo">
                    RedFPE
                </a>
                        ...
                        @else
                            ...
                            @if(Auth::user()->rol === 'admin')
                                ...
                                <li class="nav-item ms-2">
                                    <a class="btn btn-danger px-4" href="{{ route('admin.panel') }}">
                            ...
                            @if(Auth::user()->rol === 'academia')
                                <li class="nav-item ms-2">
                                    <a class="btn btn-primary px-4" href="{{ route('academia.miscursos') }}">
                            ...
                            @if(Auth::user()->rol === 'profesor')
                                <li class="nav-item ms-2">
                                    <a class="btn btn-primary px-4" href="{{ route('profesor.miscursos') }}">
    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer-logo mb-4">
                    <div class="d-flex align-items-center mb-3">
                        <img src="{{ asset('mundo.png') }}" alt="RedFPE Logo" style="height: 40px; filter: brightness(0) invert(1);" class="me-2">
            ...
            <div class="col-lg-2 col-md-6">
                <h5 class="text-white mb-4" style="position: relative; padding-bottom: 10px;">
                    Enlaces
                ...
                <ul class="list-unstyled">
                    <li class="mb-2">
                        <a href="{{ url('/') }}" class="text-light text-decoration-none d-flex align-items-center" style="opacity: 0.8; transition: all 0.3s ease;">
                            <i class="fas fa-home me-2" style="width: 20px;"></i>
                            <span>Inicio</span>
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('about') }}" class="text-light text-decoration-none d-flex align-items-center" style="opacity: 0.8; transition: all 0.3s ease;">
                            <i class="fas fa-info-circle me-2" style="width: 20px;"></i>
                            <span>Sobre Nosotros</span>
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('privacy') }}" class="text-light text-decoration-none d-flex align-items-center" style="opacity: 0.8; transition: all 0.3s ease;">
                            <i class="fas fa-user-shield me-2" style="width: 20px;"></i>
                            <span>Privacidad</span>
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('terms') }}" class="text-light text-decoration-none d-flex align-items-center" style="opacity: 0.8; transition: all 0.3s ease;">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2">
                        <a href="{{ route('academias') }}" class="text-light text-decoration-none d-flex align-items-center" style="opacity: 0.8; transition: all 0.3s ease;">
                            <i class="fas fa-university me-2" style="width: 20px;"></i>
                            <span>Academias</span>
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('docentes') }}" class="text-light text-decoration-none d-flex align-items-center" style="opacity: 0.8; transition: all 0.3s ease;">
                            <i class="fas fa-chalkboard-teacher me-2" style="width: 20px;"></i>
                            <span>Docentes</span>
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('alumnos') }}" class="text-light text-decoration-none d-flex align-items-center" style="opacity: 0.8; transition: all 0.3s ease;">
                            <i class="fas fa-user-graduate me-2" style="width: 20px;"></i>
                            <span>Alumnos</span>
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href={{ route('ayuda') }} class="text-light text-decoration-none d-flex align-items-center" style="opacity: 0.8; transition: all 0.3s ease;">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled text-light" style="opacity: 0.8;">
                    <li class="mb-3 d-flex align-items-start">
                        ...
                        <span>info@redfpe.com</span>
                    </li>
                    <li class="mb-3 d-flex align-items-start">
                        <i class="fas fa-phone mt-1 me-3" style="color: #4cc9f0; width: 20px;"></i>
                        <span>+34 635 15 62 63</span>
                    </li>
                    <li class="mb-3 d-flex align-items-start">
                        <i class="fas fa-map-marker-alt mt-1 me-3" style="color: #4cc9f0; width: 20px;"></i>
                        <span>Avenida de Vigo 63<br>Pontevedra, España</span>
                    </li>
                </ul>
                <div class="social-links mt-4">
                    <a href="#" class="text-light me-3" style="opacity: 0.7; transition: all 0.3s ease;">
