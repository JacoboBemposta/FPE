                                ...
                                <div class="col-md-6">
                                    <div class="p-3 rounded" style="background-color: white;">
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <h6 class="fw-bold mb-0">Sesión de usuario</h6>
                                        </div>
                                        <p class="text-muted mb-0 small">Mantiene tu sesión activa mientras usas la plataforma</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="p-3 rounded" style="background-color: white;">
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <h6 class="fw-bold mb-0">Seguridad</h6>
                                        </div>
                                        <p class="text-muted mb-0 small">Protege tu cuenta contra accesos no autorizados</p>
                                    </div>
                                </div>
                            </div>
                        </div>
