        ...
        <div class="card-body">
            ...
            <form id="searchForm" method="GET" action="{{ route('profesor.ver_academias') }}" class="mb-5">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-floating">
                            <select name="tiene_docente" class="form-select" id="docenteSelect">
                                <option value="" {{ request('tiene_docente') === null ? 'selected' : '' }}>Todos</option>
                                <option value="1" {{ request('tiene_docente') === "1" ? 'selected' : '' }}>Con docente</option>
                                <option value="0" {{ request('tiene_docente') === "0" ? 'selected' : '' }}>Sin docente</option>
                            </select>
                            <label for="docenteSelect"><i class="fas fa-chalkboard-teacher me-2"></i>Docente asignado</label>
                        </div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($cursoAcademico->docente_nombre)
                                        {{ $cursoAcademico->docente_nombre }}
                                    @else
                                        <span class="text-muted"><i class="fas fa-user-times text-danger"></i> No asignado</span>
                                    @endif
                                </td>
                            </tr>
                        @empty
